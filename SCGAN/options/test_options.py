...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument('--snapshot_path', type=str, default='./SCGAN/check/') # 模型路径 相对于 最先执行的文件
        self.parser.add_argument('--save_path', type=str, default='./results/') # 结果保存路径   相对于 最先执行的文件
