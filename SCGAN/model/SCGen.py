...
class SCGen(nn.Module):
    ...
    def __init__(self, dim, style_dim, n_downsample, n_res, mlp_dim, n_componets, input_dim, activ='relu',
        ...
        self.PSEnc = PartStyleEncoder(input_dim, dim, int(style_dim / n_componets), norm='none', activ=activ,
                                      pad_type=pad_type, \
                                      ispartial=self.ispartial, isinterpolation=self.isinterpolation)
...
class PartStyleEncoder(nn.Module):
    def __init__(self, input_dim, dim, style_dim, norm, activ, pad_type, ispartial, isinterpolation):
