...
class SCDataset():
    def __init__(self, opt):
        ...
        self.dir_makeup = opt.dirmap    # 妆容图片 路径
        self.dir_nonmakeup = opt.dataroot  # 原始图片路径
    ...
    def __getitem__(self, index):
        ...
        # nonmakeup_path = './SCGAN/mydata/imgs/no_makeup/l116.png'
        # nonmakeup_path = self.source    # 源文件路径
        # makeup_path = os.path.join(self.dir_makeup, makeup_name)
        # makeup_path = './SCGAN/mydata/imgs/makeup/a.png'
        # makeup_path = self.scgan_source  # 妆容文件 路径
        # print(self.dir_nonmakeup, self.dir_makeup)

        makeup_img = Image.open(self.dir_makeup).convert('RGB')
        nonmakeup_img = Image.open(self.dir_nonmakeup).convert('RGB')
        ...
        nonmakeup_seg_img = Image.open('./SCGAN/face_mask/mask.png')   # 固定路径 与 文件名
        makeup_seg_img = Image.open('./SCGAN/face_mask/a.png')

        # nonmakeup_seg_img = Image.open('./mydata/parsing/no_makeup/mask.png')   # 固定路径 与 文件名
        # makeup_seg_img = Image.open('./mydata/parsing/makeup/scgan.png')
